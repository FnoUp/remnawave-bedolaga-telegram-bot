...
def _connection_guide_intro_text(texts, *, has_media: bool) -> str:
    if has_media:
        return texts.t(
            ...
            'На картинке выше — цветные подсказки прямо на экране приложения.\n'
            'Полная инструкция (установка Happ, смена региона App Store) — в статье по кнопке ниже.',
        )
    return texts.t(
        'CONNECTION_GUIDE_CAPTION',
        '🎥 <b>Как подключиться</b>\n\n'
        'Разберётесь за 2 минуты:\n'
        '• «📖 Подробная инструкция» — установка Happ, смена региона App Store, обзор кнопок\n'
        '• «🎥 Видео» — короткая наглядная инструкция',
    )
